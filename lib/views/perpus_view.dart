...
import 'package:perpustakaan/controllers/movie_controller.dart';
...
class _MovieViewState extends State<MovieView> {
  ...
  void filterSearchResults(String query) {
    List<Perpus>? dummySearchList = film;
    if (query.isNotEmpty) {
      List<Perpus> dummyListData = dummySearchList!.where((item) {
